...
Security.fi on julkaissut aiheesta [kattavan GDPR-oppaan kameravalvonnan toteuttajille](https://security.fi), jossa käydään läpi käytännön toteutuksen vaiheet yritysympäristössä.
