...
Security.fi on julkaissut aiheesta [Security.fi:n opas kameravalvonnan lakivelvoitteisiin](https://www.security.fi/kameravalvonta/laki-suomessa/), jossa käydään läpi käytännön toteutuksen vaiheet yritysympäristössä.
