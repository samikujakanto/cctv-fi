...
[Security.fi:n tekninen opas kameravalvontajärjestelmien konfigurointiin](https://security.fi) sisältää NVR-kohtaiset ohjeet automaattipoiston asettamiseen.
